  ...
  return <div className="w-full bg-transparent font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl py-20 px-4 lg:px-10 md:px-[29px] mx-[6px] my-0">
        ...
        <p className="text-muted-foreground text-sm md:text-base max-w-3xl">
          Explore my academic and professional journey from school to university, highlighting my growth in AI/ML, participation in hackathons, and valuable internship experiences.
        </p>
      </div>
